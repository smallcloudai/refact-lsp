...
pub async fn create_chat_scratchpad(
    ...
    if scratchpad_name == "CHAT-GENERIC" {
        ...
        result = Box::new(chat_passthrough::ChatPassthrough::new(tokenizer_arc.clone(), post, messages, global_context.clone(), allow_at, supports_tools, supports_clicks, style));
    } else {
