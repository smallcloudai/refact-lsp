...
//     pub file_text_hash: String,
//     pub file_path: Path,
//     pub start_line: i32,
//     pub end_line: i32,
//     pub time_added: DateTime<chrono::Utc>,
//     pub model_name: str
// }
//
// #[derive(Debug, Serialize, Deserialize, Clone)]
...
//             Field::new("window_text", DataType::Utf8, false),
...
//         ]));
//         VecDBHandler {
//             database_path: cache_dir.join("vecdb"),
//             database: conn,
//             schema,
...
//     }
//
//     pub async fn add_or_update(&self, records: Vec<Record>) -> vectordb::error::Result<()> {
