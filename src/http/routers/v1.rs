...
use crate::http::routers::v1::diffs::{handle_v1_diff_apply, handle_v1_diff_undo, handle_v1_is_diff_applied};
...
pub fn make_v1_router() -> Router {
    Router::new()
        ...
        .route("/is-diff-applied", telemetry_post!(handle_v1_is_diff_applied))
}
