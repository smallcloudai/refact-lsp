...
async def welcome_message(settings: cli_settings.CmdlineSettings, tip: str):
    text = f"""
~/.config/refact/cli.yaml                -- set up this program
~/.config/refact/bring-your-own-key.yaml -- set up models you want to use
~/.config/refact/integrations.yaml       -- set up github, jira, make, gdb, and other tools, including which actions require confirmation
